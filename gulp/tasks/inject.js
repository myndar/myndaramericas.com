...
gulp.task('inject:head', () =>
  gulp.src('.tmp/src/_includes/head.html')
    ...
    .pipe(gulp.dest('.tmp/src/_includes')) // gets copied into src by build:site > copy:site
);
...
gulp.task('inject:footer', () =>
  gulp.src('.tmp/src/_layouts/default.html')
    ...
    .pipe(gulp.dest('.tmp/src/_layouts')) // gets copied into src by build:site > copy:site
);
